...
color = st.selectbox("Select a color", options=["Red", "Green", "Blue",'Yellow','Orange','Black'])
st.write("You selected:", color)

st.write("st.multiselect can be used to get a multi-option select box.")
colors = st.multiselect("Select colors", options=["Red", "Green", "Blue",'Yellow','Orange','Black'])
